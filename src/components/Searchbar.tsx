  ...
  return (
    <div className="w-100% sm:w-full">
      <div className="flex items-center justify-center">
        <form className="hidden md:flex items-center mx-auto  max-w-xs sm:max-w-sm lg:max-w-lg xl:max-w-xl md:max-w-md w-full">
        ...
        <form className="flex  md:hidden mx-auto cursor-pointer">
          <FaSearch />
        </form>
      </div>
      {isOpen && (
